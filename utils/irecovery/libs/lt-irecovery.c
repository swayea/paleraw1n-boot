...
/* ./.libs/lt-irecovery.c - temporary wrapper executable for .libs/irecovery.exe
   Generated by libtool (GNU libtool) 2.4.7

   The irecovery program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\palera1n-win\\libirecovery\\src\\.libs;C:\\msys64\\mingw64\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\palera1n-win\\libirecovery\\src\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "irecovery.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# irecovery - temporary wrapper script for .libs/irecovery.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The irecovery program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libirecovery-1.0.la C:/msys64/mingw64/lib/libimobile", f);
  fputs ("device-glue-1.0.la /mingw64/lib/libplist-2.0.la C:/msys64/mingw64/lib/libplist-", f);
  fputs ("2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"irecovery.exe:irecovery:$LINENO: libtool wrapper (GNU libtool) 2.4.7\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"irecovery.exe:irecovery:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"irecovery.exe:irecovery:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/d/palera1n-win/libirecovery/src/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/palera1n-win/libirecovery/src/.libs:/mingw64/lib:$PATH\"\n", f);
  fputs ("\n", f);
